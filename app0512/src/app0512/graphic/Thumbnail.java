...
//Jpanel은 ActionListner가 안먹힘
public class Thumbnail extends JPanel implements MouseListener{
	PhotoAlbum photoAlbum;
	Toolkit kit; //이미지를 얻을 수 있는 클래스
	Image image; //추상 클래스이므로 new 불가
	
	public Thumbnail(PhotoAlbum photoAlbum) {
		this.photoAlbum = photoAlbum;
		
		kit = Toolkit.getDefaultToolkit(); //static메서드, 즉 클래스 소속 메서드
		image = kit.getImage("C:\\korea202102_javaworkspace\\app0512\\res\\images\\jeju.jpg");
