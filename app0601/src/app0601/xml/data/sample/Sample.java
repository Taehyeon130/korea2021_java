...
public class Sample {
	...
	//throws : 개발자가 해당예외를 처리하지 않고 메서드 호출자에게 전가시키겠다
	//아래의 코드에서 main메서드를 호츨한 자는 jvm이므로, 혹여나 예외가 발생한다면 jvm에 의해 예외처리 결과가 출력!!
	public static void main(String[] args) throws IOException{
		String key="hl4BZLiOs3K8cuJVVrDAj8tf7pZ09ywZT2to%2BGtx1NDjRi%2FPGZPAUvriQqZFmeCV5BbYqkeao2JLr%2Bl4RF3%2FnA%3D%3D";
